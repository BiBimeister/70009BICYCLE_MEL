...
function r(s, h, u) {
    ...
    1 : [function(e, t, n) {
        ...
        function i(e, t, n, i) {
            if (this.options = i || {},
            this._mapA = e, this._mapB = t, this._horizontal = "horizontal" === this.options.orientation, this._onDown = this._onDown.bind(this), this._onMove = this._onMove.bind(this), this._onMouseUp = this._onMouseUp.bind(this), this._onTouchEnd = this._onTouchEnd.bind(this), this._ev = new h, this._swiper = document.createElement("div"), this._swiper.className = this._horizontal ? "compare-swiper-horizontal": "compare-swiper-vertical", this._controlContainer = document.createElement("div"), this._controlContainer.className = this._horizontal ? "mapboxgl-compare mapboxgl-compare-horizontal": "mapboxgl-compare", this._controlContainer.className = this._controlContainer.className, this._controlContainer.appendChild(this._swiper), "string" == typeof n && document.body.querySelectorAll) {
        ...
        i.prototype = {
            ...
            on: function(e, t) {
                return this._ev.on(e, t),
                this
            },
            fire: function(e, t) {
                return this._ev.emit(e, t),
                this
            },
            off: function(e, t) {
                return this._ev.removeListener(e, t),
                this
            },
            remove: function() {
                this._clearSync(),
    ...
    3 : [function(e, t, n) {
        ...
        function v(e, t, n) {
            ...
            if (!i) return [];
            var o = i[t];
            return o ? "function" == typeof o ? n ? [o.listener || o] : [o] : n ?
            function(e) {
        ...
        i.prototype.emit = function(e, t, n, i) {
            ...
            case 2:
                ...
                function(e, t, n, i) {
                    ...
                    r = _(e, o), s = 0; s < o; ++s) r[s].call(n, i)
                } (r, f, this, t);
                break;
            case 3:
                !
                function(e, t, n, i, o) {
                    ...
                    s = _(e, r), h = 0; h < r; ++h) s[h].call(n, i, o)
                } (r, f, this, t, n);
                break;
            case 4:
                !
                function(e, t, n, i, o, r) {
                    ...
                    h = _(e, s), u = 0; u < s; ++u) h[u].call(n, i, o, r)
                } (r, f, this, t, n, i);
                break;
            default:
                ...
                function(e, t, n, i) {
                    ...
                    r = _(e, o), s = 0; s < o; ++s) r[s].apply(n, i)
                } (r, f, this, h)
            }
            return ! 0
        },
        ...
        i.prototype.removeListener = function(e, t) {
            ...
            if (n === t || n.listener === t) 0 == --this._eventsCount ? this._events = u(null) : (delete i[e], i.removeListener && this.emit("removeListener", e, n.listener || t));
                ...
                0 === o ? n.shift() : function(e, t) {
                    for (var n = t,
                    i = n + 1,
                    o = e.length; i < o; n += 1, i += 1) e[n] = e[i];
                    e.pop()
                } (n, o),
                1 === n.length && (i[e] = n[0]),
        ...
        i.prototype.removeAllListeners = function(e) {
            ...
            if (!n.removeListener) return 0 === arguments.length ? (this._events = u(null), this._eventsCount = 0) : n[e] && (0 == --this._eventsCount ? this._events = u(null) : delete n[e]),
            this;
